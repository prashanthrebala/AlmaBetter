...
// map will convert element to something new
// and returns a new array

// forEach is just meant to go through array
...
function coolString(stringList) {
    ...
    for(let i = 0; i < stringList.length; i++) {
        ...
        // Print here to check whatever you want
        // console.log(i + " " + currentString + " " + currentString.charAt(i));
        ans += currentString.charAt(i)
...
// Problem 13
// given the datastructure (from problem 12) and a number,
...
// one-line code
// dataStructure.has(num) ? dataStructure.get(num) : 0;
